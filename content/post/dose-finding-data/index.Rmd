...
In these circumstances, we broke the doses up to form fully orderable subsets.

There are many possible subsets of a set so the way we formed these subsets was unavoidably subjective.
We sought to maximise the size of the largest fully orderable subset.
Furthermore, we avoided allocating a dose to several sets unless repetition was the only way to avoid having an orphan dose (i.e. a subset of size 1).
